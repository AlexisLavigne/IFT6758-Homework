...
BUILD_ID="b48a9696-4eeb-49bb-b285-0981390cfc18"
BACKEND_URL="https://backendv1-627969713837.us-central1.run.app"
...
IMAGE_URI="${REGISTRY}/${PROJECT_ID}/${REPO_NAME}/frontend_v1:${BUILD_ID}"
